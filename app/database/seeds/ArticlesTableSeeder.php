...
class ArticlesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('articles')->insert([
            ...
            b)	 El Derecho de Trabajo constituye <span class="opNum">2.</span> <span>un mínimum de garantías sociales</span>, protectoras del trabajador, <span class="opNum">3.</span> <span>irrenunciables únicamente para éste y llamadas a desarrollarse posteriormente</span> en forma dinámica, en estricta conformidad con las posibilidades de cada empresa patronal, mediante la contratación individual o colectiva y, <span class="opNum">4.</span> <span>de manera muy especial, por medio de los pactos colectivos de condiciones de trabajo.</span>',
